...
try:
    #res = cos.download_file('bucketjptok0001', 'test.txt', '/home/jjamisola1/03102023/ibm-cos-sdk-python/test.txt')
    res = cos.download_file('bucketjptok0001', 'test.txt', 'test.txt')
